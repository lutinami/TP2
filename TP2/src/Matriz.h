...
public:
	...
	Matriz(int n, int m);			// Matriz aleatoria de n filas y m columnas
	...
	// Setters ---------------------------------------------------------------------------------------------------------
	void setMatriz(vector<vector<double>> mat);	// Cambia la matriz con un vector 2D
	void setMatrizUnidad(int n, int m, double a);	// Cambia la matriz por una matriz "a" de n filas y m columnas
	void setMatrizAleatoria(int n, int m);		// Cambia la matriz por una matriz aleatoria de n filas y m columnas 
	// -----------------------------------------------------------------------------------------------------------------
